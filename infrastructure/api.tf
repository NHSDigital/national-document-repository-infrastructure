...
resource "aws_api_gateway_gateway_response" "unauthorised_response" {
  ...
  response_parameters = {
    ...
    "gatewayresponse.header.Access-Control-Allow-Headers"     = "'Content-Type,X-Amz-Date,Authorization,Authorizationtoken,X-Api-Key,X-Amz-Security-Token,X-Auth-Cookie,Accept'"
