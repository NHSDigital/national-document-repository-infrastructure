...
resource "aws_api_gateway_integration_response" "preflight_integration_response" {
  ...
  response_parameters = {
    "method.response.header.Access-Control-Allow-Headers"     = "'Content-Type,X-Amz-Date,Authorization,Authorizationtoken,Cookie,X-Api-Key,X-Amz-Security-Token,X-Auth-Cookie,Accept'",
