...
| <a name="module_ndr-docker-ui"></a> [ndr-docker-ui](#module\_ndr-docker-ui) | ./modules/ecr/ | n/a |
...
| <a name="input_sub_domain"></a> [sub\_domain](#input\_sub\_domain) | n/a | `string` | n/a | yes |
